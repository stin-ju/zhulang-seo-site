...
function BootstrapLoading() {
  return (
    <div className="min-h-screen bg-night text-text-primary flex items-center justify-center">
...
function BootstrapError({ message }: { message: string }) {
  return (
    <div className="min-h-screen bg-night text-text-primary flex items-center justify-center px-6">
