...
function renderMatchCard(match) {
    ...
    const leagueBadge = leagueName
        ? `<span style="display:inline-block;font-size:11px;line-height:1;padding:2px 6px;border-radius:4px;margin-right:6px;vertical-align:middle;flex-shrink:0;${
            isBasketball
    ...
    const handicapDisplay = !isNaN(handicapVal)
        ? (handicapVal > 0 ? '+' + match.handicap : match.handicap)
        : (match.handicap || '');
